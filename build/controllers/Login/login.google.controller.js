...
var CLIENT_ID = process.env.GG_CLIENT_ID;

// Tạo một phiên bản của OAuth2Client với ID Google Client của bạn
var client = new OAuth2Client(process.env.GG_CLIENT_ID, process.env.GG_CLIENT_SECRET);
var verifyGoogleToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var idToken, ticket, payload;
  ...
  return function verifyGoogleToken(_x, _x2) {
